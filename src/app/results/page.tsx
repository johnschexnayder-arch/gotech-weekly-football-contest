...
export default async function ResultsPage({
  ...
  /*
   * Sort using the actual rank generated by
   * the scoring engine.
   *
   * If two players have the same tiebreaker
   * rank, they remain tied. Alphabetical order
   * is used only to keep the display stable.
   */
  results.sort(
    (a, b) => {
      if (
