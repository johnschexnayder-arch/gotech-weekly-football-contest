      ...
      <section className="rounded-3xl border border-yellow-400/20 bg-white p-6 shadow-xl">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button
            ...
            className="rounded-xl border-2 border-yellow-400 bg-green-950 px-6 py-3 font-black uppercase tracking-wide text-white shadow-lg transition hover:bg-green-900"
          >
            Create Week
          </button>
        </div>
              ...
              >
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  ...
                  <button
                    ...
                    className="rounded-xl bg-red-600 px-5 py-2 font-black text-white transition hover:bg-red-700"
                  >
                    Delete
                  </button>
                </div>
